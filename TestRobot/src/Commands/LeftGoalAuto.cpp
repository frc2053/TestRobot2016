...
{
	AddSequential(new DriveCommandAuto(0, 1, 0, .6, 0)); //drive in rough direction of goal
	...
	AddSequential(new DriveCommandAuto(0, 0, 0, 2, 180)); //turn around to go through defense
}
